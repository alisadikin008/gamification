...
let campaignAttachments = require('../repositories/campaignAttachmentRepository');
...
router.get('/', function(req, res, next) {
  campaignAttachments
    .findAll(req)
    .then(results => {
        campaignAttachments.countAll(req).then(countData=>{
...
router.get('/:id', function(req, res, next) {
    campaignAttachments.findById(req).then(data => {
        let responsData = {
            status: 'OK',
            data: data,
        };
...
router.post('/', function(req, res, next) {
    try{
        campaignAttachments.createNew(req).then(data=> {
            let responsData = {
                status: 'Success',
                data: data,
            };
